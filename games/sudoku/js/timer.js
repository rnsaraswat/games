...
//         state.timerTick = setInterval(updateTimerDisplay, 1000);
...
//     elapsedTime = Date.now() - state.timerTick;
//     const totalSeconds = Math.floor(state.timerTick / 1000);
...
//     if (!state.paused && !state.timerTick) {
//         startTimer();
//     }
//     if (state.paused) {
