...
window.addEventListener('load', function () {
    ...
    // let viewportWidth = (document.documentElement.clientWidth / 100 * 50) + 'vw';
    // let viewportHeight = (document.documentElement.clientHeight / 100 * 50) + 'vw';
    let widthInVW = document.documentElement.clientWidth / 100;
    let viewportWidth = widthInVW * 50;
    let heightInVW = document.documentElement.clientHeight / 100;
    let viewportHeight = heightInVW * 50;
    console.log("document.documentElement.clientWidth", document.documentElement.clientWidth)
    console.log("widthInVW", widthInVW)
    console.log("viewportWidth", viewportWidth)
    console.log("viewportWidth -7vw", (viewportWidth + -7));
    console.log("viewportWidth 3vw", viewportWidth + 3);
    ...
    // var testTubePosition = {
    //     0: [[-45, 300], [45, 300],                [-45, 500], [45, 500]],
    //     1: [[-75, 300], [15, 300], [75, 300],    [-45, 500], [45, 500]],
    //     2: [[-75, 300], [15, 300], [75, 300], [-75, 500], [15, 500], [75, 500]],
    //     3: [[-75, 300], [15, 300], [75, 300], [-45, 500], [45, 500], [-45, 700], [45, 700]],
    //     4: [[-75, 300], [15, 300], [75, 300], [-75, 500], [15, 500], [75, 500], [-45, 700], [45, 700]],
    //     5: [[-75, 300], [15, 300], [75, 300], [-75, 500], [15, 500], [75, 500], [-75, 700], [15, 700], [75, 700]],
    //     6: [[-105, 300], [-45, 300], [45, 300], [105, 300], [-75, 500], [15, 500], [75, 500], [-75, 700], [15, 700], [75, 700]],
    //     7: [[-105, 300], [-45, 300], [45, 300], [105, 300], [-105, 500], [-45, 500], [45, 500], [105, 500], [-75, 700], [15, 700], [75, 700]],
    //     8: [[-105, 300], [-45, 300], [45, 300], [105, 300], [-105, 500], [-45, 500], [45, 500], [105, 500], [-105, 500], [-45, 700], [45, 700], [105, 700]],
    //     9: [[-135, 300], [-45, 300], [15, 300], [45, 300], [135, 300], [-105, 500], [-45, 500], [45, 500], [105, 500], [-105, 500], [-45, 700], [45, 700], [105, 700]],
    //     10: [[-160, 300], [-90, 300], [-20, 300], [55, 300], [135, 300],    [-135, 500], [-45, 500], [15, 500], [45, 500], [135, 500],      [-105, 700], [-45, 700], [45, 700], [105, 700]],
    // }
    let timer = false;
    let hours = 0;
    let minutes = 0;
    ...
    function ApplyInfo(a = water) {
        if (!won) {
            ...
            for (let i of testTubePosition[currentLevel]) {
                ...
                // left:calc(${viewportWidth} + ${i[0]})vw;transform:rotate(0deg);" 
                leftWidthCalc = viewportWidth + i[0];
                topHeightCalc = viewportHeight + i[1];
                console.log(leftWidthCalc);
                console.log(topHeightCalc);
                // level.innerHTML += `<div class = "test-tube" style="top:${i[1]}vw;left:${leftWidthCalc}vw;transform:rotate(0deg);" onclick="Clicked(${d});">
                //     <div class="colors" style = "background-color:${a[d][0]};top:8.5vw;"></div>
                //     <div class="colors" style = "background-color:${a[d][1]};top:6.0vw;"></div>
                //     <div class="colors" style = "background-color:${a[d][2]};top:3.5vw;"></div>
                //     <div class="colors" style = "background-color:${a[d][3]};top:1.0vw;"></div>
                // </div>`;
                level.innerHTML += `<div class = "test-tube" style="top:${topHeightCalc}vh;left:${leftWidthCalc}vw;transform:rotate(0deg);" onclick="Clicked(${d});">
                <div class="colors" style = "background-color:${a[d][0]};top:8.5vw;"></div>
                <div class="colors" style = "background-color:${a[d][1]};top:6.0vw;"></div>
                <div class="colors" style = "background-color:${a[d][2]};top:3.5vw;"></div>
                <div class="colors" style = "background-color:${a[d][3]};top:1.0vw;"></div>
    ...
    function TransferAnim(a, b) {
        ...
        topHeightCalc = viewportHeight + testTubePosition[currentLevel][b][1] - 8.0;
        // el.style.top = `calc(${testTubePosition[currentLevel][b][1]}vw - 8.0vw)`;
        el.style.top = `${topHeightCalc}vh`;
        // el.style.left = `calc(5.0vw + ${testTubePosition[currentLevel][b][0]}vw - 1.0vw)`;
        leftWidthCalc = viewportWidth + testTubePosition[currentLevel][b][0] - 6.0;
        // el.style.left = `calc(${leftWidthCalc} + ${testTubePosition[currentLevel][b][0]}vw - 6.0)vw`;
        el.style.left = leftWidthCalc + 'vw';
        ...
        setTimeout(function () {
            leftWidthCalc = viewportWidth + testTubePosition[currentLevel][a][0];
            // el.style.left = `calc(${viewportWidth} + ${testTubePosition[currentLevel][a][0]})vw`;
            el.style.left = leftWidthCalc + 'vw';

            topHeightCalc = viewportHeight + testTubePosition[currentLevel][a][1];
    ...
    function WaterDec(p, q, a, count) {
        ...
        setTimeout(function () {
            ...
            leftWidthCalc = viewportWidth + testTubePosition[noOfTubes - 2][lequidReceivedtoTube][0] + 1.7;
        //     level.innerHTML += `<div class="rain">
        //     <div class="drop" style = "top: calc(${testTubePosition[noOfTubes - 2][lequidReceivedtoTube][1]}vw - 8.5vw); left: calc(${viewportWidth} + ${testTubePosition[noOfTubes - 2][lequidReceivedtoTube][0]}vw + 1.7vw); background-color: ${p[0]};"></div>
        // </div>`
            level.innerHTML += `<div class="rain">
            <div class="drop" style = "top: calc(${testTubePosition[noOfTubes - 2][lequidReceivedtoTube][1]}vw - 8.5vw); left: ${lequidReceivedtoTube}vw; background-color: ${p[0]};"></div>
    </div>`
        }, 50);
        setTimeout(function () {
            document.getElementsByClassName("test-tube")[a].innerHTML = `
                <div class="colors" style = "background-color:${water[a][0]};top:8.5vw;"></div>
                <div class="colors" style = "background-color:${water[a][1]};top:6.0vw;"></div>
                <div class="colors" style = "background-color:${water[a][2]};top:3.5vw;"></div>
                <div class="colors" style = "background-color:${water[a][3]};top:1.0vw;"></div>`;
        }, 1050);
    }
