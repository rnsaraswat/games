...
function showRules() {
    ...
    <p>To play Water Sort Puzzle, you <br><b>tap on a any filled colored water tube to pick it up,<br>
    then tap on another tube to pour the water into it.</b> <br>You can only pour colored water into another tube if both tubes have the same color at the top and <br>if the receiving tube has enough space. <br><br>
...
<h2>Buttons used in the game</h2><br>
<u>No of tubes(mode):</u> This dropdown menu to select no of tubes (mode) in puzzle. 4 to 14 tubes option ara available in which 2 tubes are empty. lesser the tubes easy the difficulty level and more tubes harder the difficulty level.<br>
the levels are Easy/Medium/Hard<br>
<u>Easy:</u> game required lesser transfer of lequied bewteen tubes.<br>
<u>Medium:</u> game required more transfer of lequid between tubes then easy level<br>
<u>Hard:</u> game required more transfer of lequid between tubes then medium level<br>
<b>all level are solveable.</b>
<u>Start:</u> This will display tubes with filled lequid according to no of tubes difficulty of level. the time is also start. and button renaimed as "Restart".Each time you press new puzzle is displayed.<br> Game started with easy level 1 of each no of tubes (modes).<br> As the game completd (win) by user Next game is displayed by clicking new game button.<br>
Player current game is saved and each time you start game (click new game) the current game is display until player win current. 
<u>Restart:</u> This will reset the current game puzzle and display again same puzzle.<br>
<u>undo:</u> Undo return the last lequied transfered from tube by player. By pressing this button again an again it will return last lequied transfred from tube by players. availabe undo are limited use the special case. unnecessary press undo will also reduce your score.<br>
<u>Pause:</u> This button will cover the game screen and stop timer till resume button is pressed. you cannot play and not even think about puzzle lequied transfer sequence of puzzle in pause mode.<br>
...
<br>
<b><u>play:</b></u><br> 1. select grid size and level and pres new game buttons.<br>
2. to click on tube from which lequied transfered from tube, the tube displed lide up<br>
3. to click on tube to lequied transfered into.<br>`;
